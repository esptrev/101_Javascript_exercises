...
// The lines below will test your answer. If you see an error, then it means
// that your answer is incorrect or incomplete.
// See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Errors/Not_defined
...
// Exercise 10
// Write the code necessary to produce a single array that holds all fruits then
// all vegetables in the order as they were sorted above.
...
// Write a sayHello function that adds the string
// "Hello, " to the beginning and "!" to the end of any given input.
...
// Exercise 11
// Write a function definition for a function named addOne that takes
// in a number and returns that number plus one
...
// Exercise 12
// Write a function definition named isPositive that takes in a number and
// returns true or false if that number is positive.
...
// HINT - here are example functions using comparison operators
// https://gist.github.com/ryanorsinger/e843c7d0966993bd8193f0afabe16ae0
...
// Exercise 13
// Write a function definition named isNegative that takes in a number and
// returns true or False if that number is negative.
...
// Exercise 14
// Write a function definition named isOdd that takes in a number and
// returns true or false if that number is odd.
...
// Exercise 15
// Write a function definition named isEven that takes in a number and
// returns true or false if that number is even.
...
// Exercise 16
// Write a function definition named identity that takes in any input and
// returns that input. Don't overthink this one!
...
// Exercise 17
// Write a function definition named isPositiveOdd that takes in a number and
// returns true or false if the value is both greater than zero and odd
...
// Exercise 18
// Write a function definition named isPositiveEven that takes in a number and
// returns true or false if the value is both greater than zero and even
...
// Exercise 19
// Write a function definition named isNegativeOdd that takes in a number and
// returns true or false if the value is both less than zero and odd.

function isNegativeOdd(int){
...
// Exercise 20
// Write a function definition named isNegativeEven that takes in a number and
// returns true or false if the value is both less than zero and even.
...
// Exercise 23
// Write a function definition named triple that takes in a number and
// returns triple the provided number.
...
// Exercise 24
// Write a function definition named reverseSign that takes in a number and returns
// the provided number but with the sign reversed.
...
// Exercise 25
// Write a function definition named absoluteValue that takes in a number and returns
...
// Exercise 26
// Write a function definition named isMultipleOfThree that takes in a number and returns true
// or false if the number is evenly divisible by 3.

function isMultipleOfThree(r){
    return(r % 3 === 0);
}
...
// Exercise 27
// Write a function definition named isMultipleOfFive that takes in a number and returns
// true or false if the number is evenly divisible by 5.

function isMultipleOfFive(p){
    return(p % 5 === 0);
}
...
// Exercise 28
// Write a function definition named isMultipleOfBothThreeAndFive that takes in a number and
// returns true or false if the number is evenly divisible by both 3 and 5.

function isMultipleOfBothThreeAndFive(t){
    return(t % 5 === 0 && t % 3 === 0);
}
...
// Exercise 31
// Write a function definition named cube that takes in a number and returns the number
// times itself, times itself.
...
// Exercise 32
// Write a function definition named squareRoot that takes in a number and returns the square
// root of the provided number
...
// Exercise 33
// Write a function definition named subtract that takes in two numbers and returns the first minus
// the second argument.
...
// Exercise 34
// Write a function definition named multiply that takes in two numbers and returns the first times
// the second argument.
...
// Exercise 36
// Write a function definition named quotient that takes in two numbers and returns the quotient of
...
// Exercise 37
// Write a function definition named remainder that takes in two numbers and returns the remainder of
...
// Exercise 38
// Write a function definition named sumOfSquares that takes in two numbers, squares each number, then
// returns the sum of both squares.
...
// Exercise 39
// Write a function definition named timesTwoPlusThree that takes in a number, multiplies it by two, adds 3
...
// Exercise 41
// Write a function definition named areaOfCircle that takes in a number representing a circle's radius
...
// Exercise 42
// Write a function definition named circumference that takes in a number representing a circle's radius and
...
// Write a function definition named isVowel that takes in value and returns true if the
// value is a, e, i, o, u in upper or lower case.

function isVowel(input){
    let lcInput = input.toLowerCase();
    return( lcInput === 'a'|| lcInput === 'e' || lcInput === 'i'|| lcInput === 'o' || lcInput === 'u');
}
...
// Exercise 44
// Write a function definition named hasVowels that takes in value and returns
// true if the string contains any vowels.
...
// Exercise 45
// Write a function definition named countVowels that takes in value and
// returns the count of the nubmer of vowels in a sequence.
...
function startsWithVowel(inpStr){
    return(/[aeiou]/i.test(inpStr.charAt(0)));
}
...
function endsWithVowel(word){
    return(/[aeiou]/i.test(word.charAt(word.length - 1)));
}
...
// Exercise 49
// Write a function definition named startsAndEndsWithVowel that takes in string and
// returns true if the string starts and ends with a vowel
function startsAndEndsWithVowel(lets){
    return(/[aeiou]/.test(lets.charAt(0)) && /[aeiou]/.test(lets.charAt(lets.length - 1)));
}
...
// Exercise 55
// Write a function definition named secondToLast that takes in sequence and
// returns the second to last value of that sequence.
...
// Exercise 56
// Write a function definition named thirdToLast that takes in sequence and
// returns the third to last value of that sequence.
...
// Exercise 57
// Write a function definition named firstAndSecond that takes in sequence and
// returns the first and second value of that sequence as an array
...
// Exercise 58
// Write a function definition named firstAndLast that takes in sequence and
// returns the first and last value of that sequence as an array
...
// Exercise 59
// Write a function definition named firstToLast that takes in sequence and
// returns the sequence with the first value moved to the end of the sequence.
...
function getHighestNumber(sequence){
    let sortArray = sequence.sort(((a, b) => a - b));
...
// Exercise 66
// Write a function definition named getSmallestNumber that takes in sequence of numbers and
// returns the smallest number.

function getSmallestNumber(input){
    let inOrder = input.sort(((a, b) => a - b));
    return(inOrder[0]);
}
...
// Exercise 67
// Write a function definition named onlyOddNumbers that takes in sequence of numbers and
// returns the odd numbers in an array.
...
// Exercise 68
// Write a function definition named onlyEvenNumbers that takes in sequence of numbers and
...
// Exercise 70
// Write a function definition named onlyNegativeNumbers that takes in sequence of numbers and
// returns the negative numbers in an array.
...
// Exercise 71
// Write a function definition named hasEvens that takes in sequence of numbers and
// returns true if there are any even numbers in the sequence

function hasEvens(numbs){
...
// Exercise 72
// Write a function definition named countEvens that takes in sequence of numbers and
...
// Exercise 73
// Write a function definition named hasOdds that takes in sequence of numbers and
...
// Exercise 74
// Write a function definition named countOdds that takes in sequence of numbers and
// returns a count of the any odd numbers in the sequence
...
// Exercise 75
// Write a function definition named countNegatives that takes in sequence of numbers and
// returns a count of the number of negative numbers
...
// Exercise 76
// Write a function definition named countPositives that takes in sequence of numbers and
// returns a count of the number of positive numbers

function countPositives(nubs){
    let final=0;
    for (let i = 0; i < nubs.length; i++) {
        if(isPositive(nubs[i])){
            final++;
        }
    }
    return final;
...
// Exercise 77
// Write a function definition named onlyPositiveEvens that takes in sequence of numbers and
// returns an array containing all the positive evens from the sequence

function onlyPositiveEvens(ints){
    let winners=[];
    for (let i = 0; i < ints.length; i++) {
        if(isPositive(ints[i]) && isEven(ints[i])){
            winners.push(ints[i]);
        }
    }
    return winners;
...
// Exercise 78
// Write a function definition named onlyPositiveOdds that takes in sequence of numbers and
// returns an array containing all the positive odd numbers from the sequence

function onlyPositiveOdds(lots){
    let lugs = [];
    for (let i = 0; i < lots.length ; i++) {
        if(isPositive(lots[i]) && isOdd(lots[i])){
            lugs.push(lots[i]);
        }
    }
    return lugs;
...
// Exercise 79
// Write a function definition named onlyNegativeEvens that takes in sequence of numbers and
// returns an array containing all the negative even numbers from the sequence

function onlyNegativeEvens(twix){
    let losers = [];
    for (let i = 0; i < twix.length; i++) {
        if(isEven(twix[i]) && isNegative(twix[i])){
            losers.push(twix[i]);
        }
    }
    return losers;
...
// Exercise 80
// Write a function definition named onlyNegativeOdds that takes in sequence of numbers and
// returns an array containing all the negative odd numbers from the sequence

function onlyNegativeOdds(snickers){
    let final = [];
    for (let i = 0; i < snickers.length; i++) {
        if(isNegative(snickers[i]) && isOdd(snickers[i])){
            final.push(snickers[i]);
        }
    }
    return final;
}
...
function shortestString(object){
    return object.reduce((a, b) => a.length <= b.length ? a : b);
}
...
// Exercise 82
// Write a function definition named longestString that takes in sequence of strings and
// returns the longest string in the array.

function longestString(object){
    return object.reduce((a, b) => b.length <= a.length ? a : b);
}
...
// Exercise 100
// Write a function named getAverageSpentPerItem that takes in the shopping cart and
// returns the average of summing each item's quanties times that item's price.
// Hint: You may need to set an initial total price and total total quantity to zero, then
// sum up and divide that total price by the total quantity
...
// Hint: Consider creating a variable that is a object with the keys "price" and
// "quantity" both set to 0. You can then compare each item's price and quantity total to the one from "most"
